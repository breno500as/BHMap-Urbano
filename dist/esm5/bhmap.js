...
var BhMapImageService = /** @class */ (function () {
    ...
    BhMapImageService.prototype.getGeometriasEImagem = function (urlProxy, isProduction, camadasEnum, cqlFilter, largura, altura, buffer) {
        ...
        return new Observable(function (observer) {
            ...
            _this.bhMapService.getFeature(typename, cqlFilterGeometria, _this.proxyHost, _this.urlBhMap).pipe(mergeMap(function (json) {
                var features = new GeoJSON().readFeatures(json);
    ...
    BhMapImageService.prototype.getImagem = function (urlProxy, isProduction, camadasEnum, geometrias, cqlFilter, largura, altura, buffer) {
        ...
        return new Observable(function (observer) { return _this.httpClient.get("" + _this.proxyHost + _this.urlCamadas + _this.workspaceBase + "/wms?" + concatInQueryParams(parametros), { responseType: 'arraybuffer' }).subscribe(function (blob) {
            observer.next(blob);
            observer.complete();
        }, function (error) {
            console.error(error);
...
PainelSelecaoCamadasComponent.decorators = [
    { type: Component, args: [{
                ...
                providers: [{
                        ...
                        useExisting: forwardRef(function () { return PainelSelecaoCamadasComponent; }),
                        multi: true
                    }]
            },] },
];
